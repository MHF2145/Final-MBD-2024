    ...
    -- Table: CardCatalogue_Transactions
    CREATE TABLE CardCatalogue_Transactions (
        CardCatalogue_CardID char(6)  NOT NULL,
        Transactions_TransactionID char(6)  NOT NULL,
        CONSTRAINT CardCatalogue_Transactions_pk PRIMARY KEY (CardCatalogue_CardID,Transactions_TransactionID)
    );
    ...
    CREATE TABLE Customers (
        ...
        Membership_MembershipID char(6)  NOT NULL,
    ...
    -- foreign keys
    -- Reference: CardCatalogue_Transactions_CardCatalogue (table: CardCatalogue_Transactions)
    ALTER TABLE CardCatalogue_Transactions ADD CONSTRAINT CardCatalogue_Transactions_CardCatalogue FOREIGN KEY CardCatalogue_Transactions_CardCatalogue (CardCatalogue_CardID)
        REFERENCES CardCatalogue (CardID);

    -- Reference: CardCatalogue_Transactions_Transactions (table: CardCatalogue_Transactions)
    ALTER TABLE CardCatalogue_Transactions ADD CONSTRAINT CardCatalogue_Transactions_Transactions FOREIGN KEY CardCatalogue_Transactions_Transactions (Transactions_TransactionID)
